...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/dm1q/prebuilt/Image.gz
TARGET_PREBUILT_DTB := device/samsung/dm1q/prebuilt/dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/dm1q/prebuilt/recovery_dtbo
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPVH05A001"
BOARD_MKBOOTIMG_ARGS += --dtb $(TARGET_PREBUILT_DTB) --dtb_offset $(BOARD_DTB_OFFSET)
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/dm1q/bootimg.mk
...
# Properties
TARGET_VENDOR_PROP += device/samsung/dm1q/vendor.prop
